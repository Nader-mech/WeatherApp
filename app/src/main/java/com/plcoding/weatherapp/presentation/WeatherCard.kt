...
Text(text = "Today ${data.time.format(DateTimeFormatter.ofPattern("HH:mm"))}",
    modifier = Modifier.align(Alignment.End), color = androidx.compose.ui.graphics.Color.White
)
            ...
            Spacer(modifier = Modifier.height(16.dp))
            Text(text = "${data.temperatureCelsius} 'c", fontSize = 50.sp, color=androidx.compose.ui.graphics.Color.White)
            Spacer(modifier = Modifier.height(16.dp))
            Text(text = "${data.weatherType.weatherDesc} 'c", fontSize = 20.sp, color=androidx.compose.ui.graphics.Color.White)
